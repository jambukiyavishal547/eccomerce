...
urlpatterns = [
    ...
    path('ajax/validate_oldpassword/',views.validate_old_password,name='validate_oldpassword'),
    path('ajax/validate_cnewpassword/',views.validate_cnew_password,name='validate_cnewpassword'),
    path('ajax/validate_products_name/',views.validate_product_name,name='validate_products_name'),
